  ...
  return (
    <section className="categories-section container" id="kategori">
      ...
      <div className="categories-grid">
        <Link href="/katalog" className="cat-card cat-1 anim-fadeup stagger-1" data-reveal="scale">
        ...
        <Link href="/katalog" className="cat-card cat-2 anim-fadeup stagger-2" data-reveal="scale">
        ...
        <Link href="/katalog" className="cat-card cat-3 anim-fadeup stagger-3" data-reveal="scale">
        ...
        <Link href="/katalog" className="cat-card cat-4 anim-fadeup stagger-4" data-reveal="scale">
        ...
        <Link href="/katalog" className="cat-card cat-5 anim-fadeup stagger-5" data-reveal="scale">
